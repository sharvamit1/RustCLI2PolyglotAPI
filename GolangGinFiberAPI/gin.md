...
Endpoints
	...
	1. http://127.0.0.1:3001/api/v1/courses

	2. http://127.0.0.1:3001/api/v1/courses?published=yes&sort=price_asc

	3. http://127.0.0.1:3001/api/v1/courses?ids=1,3,5,6&min_price=50.0
